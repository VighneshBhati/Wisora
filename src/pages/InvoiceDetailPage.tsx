  ...
  return (
    <>
      <SEOHead 
        ...
        contentDescription={`Invoice for ${item?.title || 'session'} - ₹${invoice?.total_price} - Status: ${invoice?.status}`}
      />
           ...
           <div className="relative z-10 h-full flex flex-col justify-between">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
               ...
               <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                 ...
                 <p className="text-xl sm:text-2xl font-bold text-white">₹{invoice.total_price}</p>
               </div>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="p-4 rounded-lg bg-muted/30">
                    ...
                    <p className="text-3xl font-bold text-primary mt-1">₹{invoice.total_price}</p>
                  </div>
