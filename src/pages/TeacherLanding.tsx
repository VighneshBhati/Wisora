  ...
  const generateAiInsight = async () => {
    ...
    try {
      const messages: AIMessage[] = [
        { role: 'user', content: `As ${teacher?.display_name || 'an expert instructor'}, provide a detailed insight about: ${userPrompt}. Make it educational, inspiring, and related to learning and personal development. Keep it engaging and under 200 words.` }
      ];
      ...
      const insight = response.content || 'Sorry, I could not generate an insight at this time.';
