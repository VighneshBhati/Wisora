...
export default function TeacherSchedulePage() {
  ...
  const enhanceWithAI = async (basicInfo: { title: string; description: string }) => {
    setIsEnhancing(true);
    try {
      const systemPrompt = `You are an expert educational task manager. Your job is to enhance basic task information with educational context and make it more professional and actionable for teachers.
...
Consider this is for a teacher managing educational tasks. Make it professional, actionable, and education-focused.`;

      const prompt = `Based on this task info: "${basicInfo.title}" - "${basicInfo.description}", enhance it with educational context.`;
    ...
    <>
      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-primary">Session Tasks</h1>
              <p className="text-muted-foreground">Manage your expert tasks and schedule</p>
            </div>
            ...
            <Dialog open={isDialogOpen} onOpenChange={(isOpen) => {
              ...
              <DialogContent className="max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {editingTask ? 'Update the details of your task.' : 'Add a new task to your session schedule. AI can help enhance it!'}
                  </DialogDescription>
                </DialogHeader>
                  ...
                  {courses && courses.length > 0 && (
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="no-course">No session</SelectItem>
                          {courses.map(course => (
