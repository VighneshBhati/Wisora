        ...
        {isLoading ? (
          ...
          <Card className="glass-card border-0 hover-glow">
            <CardContent className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold mb-3 gradient-text">Create Your First Session</h3>
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Share your expertise with clients. Build engaging sessions with our AI-powered tools.
              </p>
              <Button 
            ...
            {filteredCourses.map((course) => (
              <Suspense fallback={<CourseCardSkeleton />} key={course.id}>
                <PremiumCourseCard
                  ...
                  continueButtonLabel="Manage Session"
                />
              </Suspense>
            ))}
          </div>
