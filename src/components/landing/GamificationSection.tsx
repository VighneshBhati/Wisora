      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16 sm:mb-20 lg:mb-24">
          ...
          <p className={`text-base sm:text-lg lg:text-xl max-w-4xl lg:max-w-5xl mx-auto leading-relaxed px-4 ${
            ...
            Enter the ultimate knowledge arena where expertise meets competition. 
            Connect with India's brightest minds in real-time knowledge challenges.
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Connect with India\'s top experts and peers',
