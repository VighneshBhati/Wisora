      ...
      >
          ...
          <div className="w-full md:w-[478px] text-center md:text-left">
            ...
            <div className="text-xl lg:text-2xl tracking-tighter opacity-85 text-black">
              Connect with India's top verified industry veterans for personalized 1:1 guidance sessions.
              Get real answers from professionals who've been there — starting at ₹99.
            </div>
