...
const Header: React.FC = () => {
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            {userRole === 'teacher' && (
              <>
                ...
                <DropdownMenuItem onClick={() => navigate('/teacher/invoices')}>
                  Earnings
                </DropdownMenuItem>
              </>
            )}
  ...
  const getNavLinks = () => {
    ...
    if (!isAuthenticated) {
      return (
        <>
          <li><Link to="/teachers" className={linkClass}>Browse Experts</Link></li>
          <li><Link to="/courses" className={linkClass}>Sessions</Link></li>
          <li><Link to="/auth/signup" className={linkClass}>For Institutions</Link></li>
        </>
      );
    }
    ...
    if (userRole === 'student') {
      return (
        <>
          ...
          <li><Link to="/student/courses" className={linkClass}>My Sessions</Link></li>
          <li><Link to="/teachers" className={linkClass}>Browse Experts</Link></li>
    ...
    if (userRole === 'teacher') {
      return (
        <>
          ...
          <li><Link to="/teacher/courses" className={linkClass}>My Sessions</Link></li>
          <li><Link to="/teacher/analytics" className={linkClass}>Analytics</Link></li>
          <li><Link to="/teacher/invoices" className={linkClass}>Earnings</Link></li>
        </>
      );
    }
