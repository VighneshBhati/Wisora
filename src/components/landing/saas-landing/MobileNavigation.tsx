...
const MobileNavigation: React.FC<{
  ...
  const getMobileNavLinks = () => {
    if (!isAuthenticated) {
      return [
        { label: 'Browse Experts', action: () => { navigate('/teachers'); onClose(); } },
        { label: 'Sessions', action: () => { navigate('/courses'); onClose(); } },
        { label: 'How It Works', action: () => { navigate('/'); onClose(); } },
      ];
    }
    ...
    if (userRole === 'student') {
      return [
        ...
        { label: 'My Sessions', action: () => navigate('/student/courses') },
        { label: 'Browse Experts', action: () => navigate('/teachers') },
    ...
    if (userRole === 'teacher') {
      return [
        ...
        { label: 'My Sessions', action: () => navigate('/teacher/courses') },
        { label: 'Booking Requests', action: () => navigate('/teacher/chapters') },
        { label: 'Groups', action: () => navigate('/teacher/groups') },
        { label: 'Analytics', action: () => navigate('/teacher/analytics') },
        { label: 'Earnings', action: () => navigate('/teacher/codes') }
      ];
    }
