        ...
        <div className="relative w-[73%] flex flex-col">
          ...
          <InfoBox variants={infoBoxVariants}>
            <p className="text-muted-foreground text-sm leading-relaxed">
              {PLATFORM_NAME} is India's first expert guidance platform connecting individuals, institutions, and verified professionals. Get real answers from real experience — through 1:1 sessions, group workshops, and on-campus expert visits.
            </p>
          </InfoBox>
          <HeroBottomSection
            cta={
