      ...
      >
        ...
        <motion.div variants={badgeVariants} className="flex justify-center mb-8">
          <Badge className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-6 py-2 text-lg font-bold border-0 shadow-lg">
            ...
            India's Expert Guidance Platform
        ...
        <motion.div variants={itemVariants} className="mb-8">
          ...
          <div className="flex justify-center items-center gap-8 text-muted-foreground">
            ...
            >
              ...
              <span className="text-lg font-semibold">Verified Experts</span>
            </motion.div>
            <motion.div
              variants={floatingVariants}
              animate="float"
            ...
            >
              ...
              <span className="text-lg font-semibold">1:1 Sessions</span>
            </motion.div>
            <motion.div
              variants={floatingVariants}
              animate="float"
            ...
            >
              ...
              <span className="text-lg font-semibold">15+ Domains</span>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          Connect with India's top verified industry veterans for personalized 1:1 guidance.
          Get real answers from professionals who've been there — starting at{' '}
          <span className="text-primary font-bold">₹99 for a trial session</span>.
        </motion.p>
        ...
        >
          {[
            { number: '500+', label: 'Verified Experts', icon: <Star className="w-6 h-6" /> },
            { number: '15+', label: 'Domains Covered', icon: <Bot className="w-6 h-6" /> },
            { number: '₹99', label: 'Trial Session', icon: <Flame className="w-6 h-6" /> },
          ].map((stat, index) => (
            <motion.div
              key={index}
