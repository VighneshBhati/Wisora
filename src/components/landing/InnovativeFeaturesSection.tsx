  ...
  const features = [
    {
      ...
      subtitle: 'First in India',
      description: 'Compete with peers across India in real-time knowledge challenges. Test your understanding, climb leaderboards, and earn rewards.',
      ...
      demo: {
        type: 'game',
        players: ['Arjun', 'Priya', 'Rahul', 'You'],
        question: 'What is the capital of India?',
        answers: ['New Delhi', 'Mumbai', 'Bangalore', 'Chennai'],
      }
    },
    {
      id: 'ai-voice-tutor',
