      ...
      <CardHeader className="px-4 sm:px-6 py-4 sm:py-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="gradient-text text-lg sm:text-xl font-bold">Upcoming Sessions</div>
            <span className="text-muted-foreground/80 text-xs sm:text-sm">Continue where you left off with your experts</span>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              {enrolledCourses.slice(0, 2).map((enrollment) => (
                <PremiumCourseCard
                  ...
                  status="Active"
                  instructor_name={enrollment.course.instructor_name || 'Expert'}
