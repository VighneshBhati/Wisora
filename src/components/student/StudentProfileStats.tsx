        ...
        <CardContent className="relative z-10 px-4 py-8 sm:p-8">
          <div className="flex flex-col sm:flex-row items-center sm:items-stretch gap-6">
            ...
            <div className="flex-1 flex flex-col items-center sm:items-start text-center sm:text-left gap-2">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3">
                ...
                <div className="flex items-center gap-1 text-base text-muted-foreground">
                  ...
                  {stats.completedCourses} sessions completed
                </div>
            ...
            <div className="flex flex-col items-center sm:items-end text-center sm:text-right min-w-[120px]">
              <div className="text-sm text-muted-foreground mb-1">Session Completion</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="glass-card border-0 hover-glow group">
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-2 mt-1">
              <div className="text-xs text-primary">{stats.inProgressCourses} upcoming</div>
        ...
        <Card className="glass-card border-0 hover-glow group">
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground mt-1">
              {stats.totalCreditsSpent} credits spent total
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card border-0 hover-glow group">
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground mt-1">
              Available for AI pre-assistant
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card border-0 hover-glow group">
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground mt-1">
              {3 - (stats.completedCourses % 3)} more sessions to next level
            </div>
          </CardContent>
        </Card>
      </div>
