...
export const DashboardSidebar = () => {
  ...
  const studentMenuItems: MenuItem[] = [
    { title: 'Home', url: "/personal/home", icon: Layout, description: 'Featured experts & quick help' },
    { title: 'My Sessions', url: "/personal/sessions", icon: BookOpen, description: 'Upcoming & past sessions' },
    { title: 'Browse Experts', url: "/teachers", icon: GraduationCap, description: 'Find verified experts' },
    { title: 'Messages', url: "/personal/messages", icon: MessageSquare, description: 'Chat with experts' },
    { title: 'Subscription', url: "/personal/subscription", icon: CreditCard, description: 'Plans & billing' },
    { title: 'Transactions', url: "/student/transactions", icon: FileText, description: 'Payment history' },
  ];

  const institutionalMenuItems: MenuItem[] = [
    { title: 'Dashboard', url: "/institutional/dashboard", icon: Layout, description: 'Overview & stats' },
    { title: 'User Management', url: "/institutional/users", icon: Users, description: 'Students & faculty' },
    { title: 'Expert Booking', url: "/institutional/expert-booking", icon: GraduationCap, description: 'Online & campus visits', badge: 'USP' },
    { title: 'Credits System', url: "/institutional/credits", icon: CreditCard, description: 'Balance & transactions' },
    { title: 'Events & Workshops', url: "/institutional/events", icon: Calendar, description: 'Campus events' },
    { title: 'Reports', url: "/institutional/reports", icon: BarChart3, description: 'Usage & analytics' },
  ];

  const expertMenuItems: MenuItem[] = [
    { title: 'Dashboard', url: "/expert/dashboard", icon: Layout, description: 'Earnings & overview' },
    { title: 'Booking Requests', url: "/expert/bookings", icon: BookOpen, description: 'Online & campus requests' },
    { title: 'Campus Visits', url: "/expert/campus-visits", icon: Database, description: 'Physical visit management' },
    { title: 'Earnings', url: "/expert/earnings", icon: Activity, description: 'Session & visit earnings' },
    { title: 'Profile & Pricing', url: "/expert/profile", icon: Shield, description: 'Manage your expert profile' },
    { title: 'Schedule', url: "/teacher/schedule", icon: Calendar, description: 'Availability calendar' },
    { title: 'Analytics', url: "/teacher/analytics", icon: BarChart3, description: 'Performance metrics' },
    { title: 'Brand Colors', url: "/teacher/colors", icon: Palette, description: 'Customize your brand' },
    { title: 'Settings', url: "/dashboard/settings", icon: Settings, description: 'Preferences' },
  ];

  const adminMenuItems: MenuItem[] = [
    { title: t('sidebar.dashboard'), url: "/admin/dashboard", icon: Layout, description: t('sidebar.adminOverview') },
    { title: t('sidebar.invoices'), url: "/admin/invoices", icon: FileText, description: t('sidebar.manageAllInvoices') },
    { title: t('sidebar.systemAnalytics'), url: "/admin/analytics", icon: BarChart3, description: t('sidebar.platformAnalytics') },
    { title: t('sidebar.userManagement'), url: "/admin/users", icon: Users, description: t('sidebar.manageUsers') },
    { title: t('sidebar.systemSettings'), url: "/admin/settings", icon: Settings, description: t('sidebar.platformSettings') },
  ];

  const menuItems = viewMode === 'institutional' ? institutionalMenuItems :
                   viewMode === 'expert' ? expertMenuItems :
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-muted-foreground capitalize font-medium">
                    {userRole === 'admin' ? 'Admin Portal' : viewMode === 'institutional' ? 'Institutional Portal' : viewMode === 'expert' ? 'Expert Portal' : 'Personal Portal'}
                  </span>
                </div>
              </div>
            )}
