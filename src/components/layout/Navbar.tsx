  ...
  const navLinks = [
    ...
    let sideNavLinks = [
      ...
      ...(userRole === 'student'
        ? [
          { to: '/student/dashboard', label: t('navbar.dashboard'), icon: Layout },
          { to: '/student/courses', label: 'My Sessions', icon: Search },
          { to: '/teachers', label: 'Browse Experts', icon: GraduationCap },
          { to: '/student/groups', label: t('navbar.myGroups'), icon: Users },
          { to: '/student/store', label: 'Subscription', icon: CircleDollarSign },
      ...
      ...(userRole === 'teacher'
        ? [
            { to: '/teacher/dashboard', label: t('navbar.dashboard'), icon: Layout },
            { to: '/teacher/courses', label: 'My Sessions', icon: BookOpen },
            { to: '/teacher/chapters', label: 'Booking Requests', icon: BookOpen },
            { to: '/teacher/groups', label: t('navbar.myGroups'), icon: Users },
            { to: '/teacher/invoices', label: 'Earnings', icon: Gift },
