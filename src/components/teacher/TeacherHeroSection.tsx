    ...
    <div className="glass-card p-3 sm:p-6 lg:p-8 border-0 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-6 mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm sm:text-base lg:text-lg">Ready to guide your next client? Talk to real experience.</p>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
          <Link to="/expert/profile" className="w-full sm:w-auto">
          ...
          <Link to="/expert/earnings" className="w-full sm:w-auto">
          ...
          <Link to="/expert/bookings" className="w-full sm:w-auto">
            <Button variant="outline" className="w-full sm:w-auto text-sm sm:text-base">
