    ...
    <Card className="glass-card border-0 hover-glow">
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="gradient-text text-xl">Client Insights</CardTitle>
            <p className="text-muted-foreground text-sm">Engagement overview across your sessions</p>
          </div>
        </div>
      </CardHeader>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 text-xs text-muted-foreground mb-2">
                    ...
                    <span>•</span>
                    <span>Joined {formatEnrollmentDate(student.enrollmentDate)}</span>
                  </div>
        ...
        {students.length > 6 && (
          <div className="pt-3 border-t border-primary/20">
            <button className="w-full text-center text-sm text-primary hover:text-primary/80 transition-colors">
              View all {students.length} clients
            </button>
          </div>
        )}
      </CardContent>
