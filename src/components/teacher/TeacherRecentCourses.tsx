      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="gradient-text text-xl">Recent Sessions</CardTitle>
              <CardDescription className="text-muted-foreground">Your latest expert sessions</CardDescription>
            </div>
          </div>
      ...
      <CardContent className="space-y-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span className="text-xs text-muted-foreground flex items-center gap-1">
                  ...
                  {course.enrollments?.[0]?.count || 0} clients
                </span>
        ...
        {courses.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">Create your first session to start guiding clients.</p>
