...
export const BASE_SEO_CONFIG: RouteSEOConfig = {
  ...
  '/': {
    en: {
      ...
      description: `${PLATFORM_NAME} (Know It All) connects you with verified industry veterans for 1:1 expert guidance. Real answers in 20 minutes from retired professionals, senior executives, and domain specialists.`,
  ...
  '/courses': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/courses',
    },
    ar: {
  ...
  '/teacher/dashboard': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/dashboard',
    },
    ar: {
  ...
  '/teacher/courses': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/courses',
    },
    ar: {
  ...
  '/teacher/groups/dynamic': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/groups',
    },
    ar: {
  ...
  '/teacher/chapters': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/chapters',
    },
    ar: {
  ...
  '/teacher/codes': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/codes',
    },
    ar: {
  ...
  '/teacher/analytics': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/analytics',
    },
    ar: {
  ...
  '/teacher/schedule': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/schedule',
    },
    ar: {
  ...
  '/teacher/notifications': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/notifications',
    },
    ar: {
  ...
  '/teacher/colors': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/colors',
    },
    ar: {
  ...
  '/teacher/students': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/students',
    },
    ar: {
  ...
  '/teacher/multiplayer-quiz': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/multiplayer-quiz',
    },
    ar: {
  ...
  '/teacher/invoices': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teacher/invoices',
    },
    ar: {
  ...
  '/invoices/dynamic': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/invoices',
    },
    ar: {
  ...
  '/student/dashboard': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/student/dashboard',
    },
    ar: {
  ...
  '/student/courses': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/student/courses',
    },
    ar: {
  ...
  '/student/chapters': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/student/chapters',
    },
    ar: {
      title: `فصولي | ${PLATFORM_NAME}`,
  ...
  '/student/groups': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/student/groups',
    },
    ar: {
  ...
  '/student/transactions': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/student/transactions',
    },
    ar: {
  ...
  '/chapters': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/chapters',
    },
    ar: {
  ...
  '/questions': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/questions',
    },
    ar: {
  ...
  '/teachers': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/teachers',
    },
    ar: {
  ...
  '/dashboard/settings': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/dashboard/settings',
    },
    ar: {
  ...
  '/multiplayer-quiz': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/multiplayer-quiz',
    },
    ar: {
  ...
  '/student/store': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/student/store',
    },
    ar: {
  ...
  '/student/notifications': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/student/notifications',
    },
    ar: {
  ...
  '/auth/callback': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/auth/callback',
    },
    ar: {
  ...
  '/unauthorized': {
    en: {
      ...
      ogType: 'website',
      canonical: 'https://kia.in/unauthorized',
    },
    ar: {
